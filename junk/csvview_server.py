...
class AjaxApp(object):
    ...
    @cherrypy.expose
    def getInitialImage(self, tableName ):
        print "getInitialImage: tableName = '", tableName, "'"
        # Hmmm, really should not initialize self.dbTable until here...
        columnData = self.dbTable.getColumnSpec()
